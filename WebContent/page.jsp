...
<div class="page">
  <div class="panel">
    <div class="title">
      <h1>Your order</h1>
      <h2>Thank you for choosing Kelly's!</h2>
    </div>
    <div class="content"> 
...
out.println("<h1> Thank you for choosing Kelly's Crack Coffee. Your order name is: "+username+"</h1>");
else
response.sendRedirect("index.jsp");

int qua1= Integer.parseInt(request.getParameter("quantity1"));
int qua2= Integer.parseInt(request.getParameter("quantity2"));
int qua3= Integer.parseInt(request.getParameter("quantity3"));
int qua4= Integer.parseInt(request.getParameter("quantity4"));
int abc=qua1*58; 
int def=qua2*82; 
int ghi=qua3*74; 
int jkl=qua4*43; 
int price= abc+def+ghi+jkl; 
out.println("<h1> You total today is $"+price+". Thank you for choosing Kelly's!");
